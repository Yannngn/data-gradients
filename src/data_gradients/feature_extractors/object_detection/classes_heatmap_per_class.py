...
class DetectionClassHeatmap(BaseClassHeatmap):
    ...
    def update(self, sample: DetectionSample):
        ...
        for class_id, (x1, y1, x2, y2) in zip(sample.class_ids, bboxes_xyxy, strict=False):
    ...
    def _generate_description(self) -> str:
        return (
            "The heatmap represents areas of high object density within the images, providing "
            "insights into the spatial distribution of objects. "
            "By examining the heatmap, you can quickly detect whether objects are predominantly concentrated in specific "
            "regions or if they are evenly "
            ...
            "This is done to focus on localization of objects in the scene (e.g. top-right, center, ...) independently of the "
