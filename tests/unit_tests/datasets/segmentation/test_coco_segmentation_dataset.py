...
class COCOSegmentationDatasetTest(unittest.TestCase):
    def setUp(self):
        ...
        self.train_set = COCOSegmentationDataset(root_dir=project_root / "example_dataset" / "tinycoco", split="train", year="2017")
        self.val_set = COCOSegmentationDataset(root_dir=project_root / "example_dataset" / "tinycoco", split="val", year="2017")
