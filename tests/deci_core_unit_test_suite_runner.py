...
class CoreUnitTestSuiteRunner:
    ...
    def _add_modules_to_unit_tests_suite(self):
        ...
        _add_modules_to_unit_tests_suite - Adds unit tests to the Unit Tests Test Suite
            :return:
        """
        self.unit_tests_suite.addTest(self.test_loader.loadTestsFromTestCase(AverageBrightnessTest))
        self.unit_tests_suite.addTest(self.test_loader.loadTestsFromTestCase(TestComputeHistogram))
        self.unit_tests_suite.addTest(self.test_loader.loadTestsFromTestCase(TestImageConverter))
